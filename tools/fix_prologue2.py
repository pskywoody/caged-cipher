...
new_prologue = [
    ...
    # 2. Scene1 + shenmo portrait
    {
        'speaker': '旁白',
        'text': '你推开尘封三十年的档案馆大门，空气中弥漫着旧纸张的气息。',
        'isNarration': True,
    ...
    # 4. Narrator continues
    {
        'speaker': '旁白',
        'text': '信上只有一行字："档案编号K-734。如果你能解开这一局，就能找到我。"',
        'isNarration': True
    },
    # 5. Shenmo portrait + line
    {
        'speaker': '沈墨',
        'text': '……我来了。',
        'side': 'left',
