  ...
  class GuideOrchestrator {
    ...
    initManagers() {
      ...
      this.moduleInitializer = new ModuleInitializer({
        ...
        getCurrentLevelData: () => (ctx.gameController ? ctx.gameController.currentLevelData : ctx.currentLevelData),
        getCurrentChapterData: () => (ctx.gameController ? ctx.gameController.currentChapterData : ctx.currentChapterData),
        getCurrentLevelId: () => (ctx.gameController ? ctx.gameController.currentLevelId : ctx.currentLevelId),
        getNoteMode: () => ctx.noteMode,
        setNoteMode: (v) => { ctx.noteMode = v; },
